...
const ROUTES = [
  ...
  { path: "/api/sync/rpc-roundtrip", method: "post", summary: "RPC 层同步活体验证(官方 LS 运行态): Settings(Get/SetUserSettings) 与定制类(CreateCustomizationFile↔文件真源↔GetAllWorkflows) 写→复读→还原; LS 不可用时如实返回 available:false" },
