...
## 已接入 (100)
AcknowledgeCascadeCodeEdit, AddTrackedWorkspace, ArchiveCascadeTrajectory, BranchCascade, CancelCascadeInvocation, CancelCascadeInvocationAndWait, CancelCascadeSteps, CheckChatCapacity, CheckUserMessageRateLimit, ConvergeArenaCascades, CopyBuiltinWorkflowToWorkspace, CreateCustomizationFile, CreateTrajectoryShare, CreateWorktree, DeleteCascadeMemory, DeleteCascadeTrajectory, DismissCodeMapSuggestion, EditConfiguration, GenerateCodeMap, GenerateCommitMessage, GetAllAcpRegistries, GetAllCascadeTrajectories, GetAllPlans, GetAllRules, GetAllSkills, GetAllWorkflows, GetAvailableCascadePlugins, GetCascadeMemories, GetCascadeTrajectory, GetCascadeTrajectoryGeneratorMetadata, GetCascadeTrajectorySteps, GetCascadeTranscriptForTrajectoryId, GetChangelog, GetClassInfos, GetCodeMapSuggestions, GetCodeMapsForRepos, GetCommandModelConfigs, GetCompletions, GetConversationTags, GetDebugDiagnostics, GetDeepWiki, GetDefaultWebOrigins, GetFunctions, GetLifeguardConfig, GetMatchingContextScopeItems, GetMcpPrompt, GetMcpRegistryServers, GetMcpServerStates, GetMessageTokenCount, GetModelStatuses, GetProcesses, GetProfileData, GetRepoInfos, GetRevertPreview, GetSharedCodeMap, GetTeamOrganizationalControls, GetTranscription, GetUserMemories, GetUserSettings, GetUserStatus, GetUserTrajectory, GetUserTrajectoryDebug, GetUserTrajectoryDescriptions, GetWebDocsOptions, GetWorkspaceEditState, GetWorkspaceInfos, HandleCascadeUserInteraction, Heartbeat, ImportFromCursor, InitializeCascadePanelState, InterruptWithQueuedMessage, MoveQueuedMessage, QueueCascadeMessage, RefreshCustomization, RefreshMcpServers, RemoveFromQueue, RemoveTrackedWorkspace, RenameCascadeTrajectory, ResolveOutstandingSteps, ResolveWorktreeChanges, RevertToCascadeStep, SaveCodeMapFromJson, SaveMcpServerToConfigFile, SendUserCascadeMessage, SetPinnedContext, SetUserSettings, ShareCodeMap, SpawnArenaModeMidConversation, StartCascade, StreamCascadePanelReactiveUpdates, StreamCascadeReactiveUpdates, StreamCascadeSummariesReactiveUpdates, StreamUserTrajectoryReactiveUpdates, SubmitBugReport, ToggleMcpTool, UndoWorktreeMerge, UpdateCascadeMemory, UpdateCodeMapMetadata, UpdateConversationTags, UpdateMcpServerInConfigFile
